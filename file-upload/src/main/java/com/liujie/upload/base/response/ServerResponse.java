package com.liujie.upload.base.response;
...
public class ServerResponse<T> {
  ...
  /* 以下为返回成功响应结果的各类重载静态方法 */
    ...
    public static <T> ServerResponse<T> success() {
        return new ServerResponse<>(ResponseCode.OK.getCode(), ResponseCode.OK.getMsg());
    }

    public static <T> ServerResponse<T> success(T data) {
        return new ServerResponse<>(ResponseCode.OK.getCode(), ResponseCode.OK.getMsg(), data);
    }

    public static <T> ServerResponse<T> success(String msg, T data) {
        return new ServerResponse<>(ResponseCode.OK.getCode(), msg, data);
    }

    public static <T> ServerResponse<T> saveSuccess(T data) {
        return new ServerResponse<>(ResponseCode.CREATED.getCode(), ResponseCode.CREATED.getMsg(), data);
    }

    public static <T> ServerResponse<T> deleteSuccess() {
        return new ServerResponse<>(ResponseCode.NO_CONTENT.getCode(), ResponseCode.NO_CONTENT.getMsg());
    }

    public static <T> ServerResponse<T> deleteSuccessWithCount(Number effectCount) {
        return new ServerResponse<>(ResponseCode.NO_CONTENT.getCode(), "删除成功,操作删除的数据条数为: " + effectCount);
    }
    public static <T> ServerResponse<T> deleteSuccessWithId(Number id) {
        return new ServerResponse<>(ResponseCode.NO_CONTENT.getCode(), "删除成功,操作删除的数据id为: " + id);
    }

    public static <T> ServerResponse<T> uploadSuccess(T data) {
        return new ServerResponse<>(ResponseCode.UPLOADED.getCode(), ResponseCode.UPLOADED.getMsg(), data);
    }
  ...
  /* 以下为返回失败响应结果的各类重载静态方法 */
    ...
    public static <T> ServerResponse<T> error() {
        return new ServerResponse<>(ResponseCode.INTERNAL_SERVER_ERROR.getCode(), ResponseCode.INTERNAL_SERVER_ERROR.getMsg());
    }

    public static <T> ServerResponse<T> error(String errorMessage) {
        return new ServerResponse<>(ResponseCode.INTERNAL_SERVER_ERROR.getCode(), errorMessage);
    }
